        ...
        .find({}, function(err, products){
          Product.count().exec(function(err, count){
              if (count > 0) {
                    ...
                    res.render('products/new.jade', { title: 'NGK | New Product',baseuri:baseurl, specieslist:species});
                  }     
            });        
        })        
        .limit(limit)
...
productController.create = function(req, res){         
    ...
    //     }
    //     res.render('products/new.jade', { title: 'NGK | New Product', baseuri:baseurl, specieslist:arrayRet})
    //   })
    // })    
...
productController.save  =   function(req, res){
    ...
    product.save(function(err) {
      ...
      res.render('products/new.jade', { title: 'NGK | New Product', baseuri:baseurl});
    })
 }
