                    ...
                    if (!err) {
                      Customer
                        ...
                        .exec(function (err, customer) {
                          ...
                          if (!err) {
                            res.render('salesorders/new.jade', { title: 'NGK | New Shipping', baseuri: baseurl, lotstatus: 'Outgoing', nextlot: sotk, customers: customer, drivers: driver, vehicles: vehicle });
                          } else {
...
exports.create = function (req, res) {
  ...
  // res.render('salesorders/new.jade', { title: 'NGK | New Shipping', baseuri: baseurl });
  Vehicle
      .find({ 'active': true })
      .exec(function (err, vehicle) {
        // console.log('Vehicle data=>' + vehicle)
...
exports.save = function (req, res) {
  ...
  salesorder.save(function (err) {
    ...
    res.render('salesorders/new', { title: 'NGK | New Shipping', baseuri: baseurl })
  })
}
